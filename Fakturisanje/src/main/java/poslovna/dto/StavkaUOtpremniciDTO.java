...
public class StavkaUOtpremniciDTO {
	...
	public StavkaUOtpremniciDTO(int ukupnaKolicina, double jedinicnaCena, double popust, double osnovica,
			double iznosPDVa, double stopaPDVa, double jedinicnaCenaSaPDV, ArtikalDTO artikalDTO) {
