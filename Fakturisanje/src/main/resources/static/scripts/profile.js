        	        ...
        	        success: function (data) {
        	        	...
        	        	for(i=0;i<data.length;i++){
        	        		if(data[i].tipPoslovnogPartneraDTO.naziv == 'dobavljac'){
        	        			...
        	        			divKupci.append('<tr><td>'+data[i].naziv+'</td><td>'+data[i].gradDTO.naziv+'</td><td>'+data[i].adresa+'</td><td>'+data[i].kontaktTelefon+'</td><td ><button style=\"margin-left:15%;\" class=\"btn btn-default\" onclick=\"prikaziPrimljeneNarudzbenice('+data[i].id+')\">Narudzbenice</button></td><td><button style=\"margin-left:3%;margin-right:15%;\" class=\"btn btn-default\" onclick=\"prikaziIzlazneFakture('+data[i].id+')\">Izlazne fakture</button></td></tr>');
        	        			ceoDivKup.append(divKupci);
        	        		}else if(data[i].tipPoslovnogPartneraDTO.naziv == 'kupacdobavljac'){
        	        			divKupDob.append('<tr><td>'+data[i].naziv+'</td><td>'+data[i].gradDTO.naziv+'</td><td>'+data[i].adresa+'</td><td>'+data[i].kontaktTelefon+'</td><td><button style=\"margin-left:10%;\" class=\"btn btn-default\" onclick=\"prikaziPrimljeneNarudzbenice('+data[i].id+')\">Primljene </button></td><td><button style=\"margin-left:2%;\" class=\"btn btn-default\" onclick=\"prikaziNaseNarudzbenice('+data[i].id+')\">Kreirane</button></td><td><button style=\"margin-left:10%;\" class=\"btn btn-default\" onclick=\"prikaziUlazneFakture('+data[i].id+')\">Ulazne</button></td><td><button style=\"margin-left:2%;\" class=\"btn btn-default\" onclick=\"prikaziIzlazneFakture('+data[i].id+')\">Izlazne</button></td>');
